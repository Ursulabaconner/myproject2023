...
<head>
    ...
    <title>Product Details | AK-cosplay</title>
	...
	<section>
		<div class="container">
			<div class="row">
				...
				include "connect.php";
					$view=$_GET["id_view"];
					$strSQL = "SELECT * FROM productmaster WHERE pm_id=$view";
				...
				<div class="col-sm-9 padding-right">
					<div class="product-details"><!--product-details-->
						...
						<div class="col-sm-7">
							<form class="product-information" action="check_order.php" method="post"><!--/product-information-->
								<!--<img src="images/product-details/new.jpg" class="newarrival" alt="" />-->
								<h2><?php echo $objResult["pm_name"];?></h2>
								<p><b>Detail:</b><?php echo $objResult["pm_detail"];?></p>
								<p><b>Size:</b><?php echo $objResult["pm_size"];?></p>
								<p><b>Condition:</b> New</p>
								<p><b>Brand:</b> AK-cosplay</p>
								<img src="images/product-details/rating.png" alt="" />
								<span>
									<span><?php echo $objResult["pm_price"];?></span>
									<label>Quantity:</label>
									<input type="text" name="txtQty" value="1" min="1"/>
