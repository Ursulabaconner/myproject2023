	...
	<section>
		<div class="container">
			<div class="row">
				...
				<!--Search-->
					<div class="col-sm-9">
						<form class="search_box pull-right" action="<?php echo $_SERVER['SCRIPT_NAME'];?>" method="post">
							<input type="text" name="txtKeyword" id="txtKeyword" value="<?php echo $strKeyword?>" placeholder="Search"/>
						</form>
					</div>
					<!--/Search-->
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						<?php
							...
							{
						?>
						<form class="col-sm-4" action="check_order.php" method="post">
							<div class="product-image-wrapper ">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="../Project_admid/<?php echo $objResult["pm_img"];?>" alt="" />
											<h2><?php echo $objResult["pm_price"];?></h2>
											<p><?php echo $objResult["pm_name"];?></p>
											<input type="hidden" name="txtProductID" value="<?php echo $objResult["pm_id"];?>" size="2">
											<input type="hidden" name="txtQty" value="1" >
											<input class="btn btn-default add-to-cart " type="submit" value="Add to cart">
											<a href="product_detail.php?id_view=<?php echo $objResult["pm_id"];?>" class="btn btn-default add-to-cart"><i class=""></i>View</a>
										</div>
										...
										<!--<div class="product-overlay">
											<div class="overlay-content">
												<h2><?php echo $objResult["pm_price"];?></h2>
												<p><?php echo $objResult["pm_name"];?></p>
												<a href="product_detail.php" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>-->
								</div>
								<div class="choose">
									<ul class="nav nav-pills nav-justified">
										<li><a href="cart.php"><i class="fa fa-plus-square"></i>Add to Cart</a></li>
										<li><a href="confirm.php"><i class="fa fa-plus-square"></i>Add to compare</a></li>
									</ul>
								</div>
							</div>
						</form >
