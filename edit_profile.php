			...
			<div class="row">
				<div class="col-sm-4 ">
					<div class="signup-form"><!--sign up form-->
						<h2>Edit Profile!</h2>
						<form action="edit_member_done.php?id_edit=<?php echo $Uid?>" method="post" enctype="multipart/form-data">
							<input name="mb_user" type="text" placeholder="Username" value=<?php echo $objResult["mb_username"];?>>
							<input name="mb_pw" type="password" placeholder="Password" value=<?php echo $objResult["mb_password"];?>>
							<input name="mb_email" type="email" placeholder="Email Address" value=<?php echo $objResult["mb_email"];?>>
							<input name="mb_FN" type="text" placeholder="Firstname" value=<?php echo $objResult["mb_firstName"];?>>
							<input name="mb_LN" type="text" placeholder="Lastname" value=<?php echo $objResult["mb_lastName"];?>>
							<input name="mb_phone" type="text" placeholder="Phone" value=<?php echo $objResult["mb_phone"];?>>
							<div class="chose_area">
								<div class="user_option">
									<label for="input-male">Male</label>
									<input type="radio" id="input-male" name="mb_gen"  value="Male">
									<label for="input-women">Women</label>
									<input type="radio" id="input-women" name="mb_gen"  value="Women">
									<label for="input-women">not specified</label>
									<input type="radio" id="input-women" name="mb_gen"  value="null">
								</div>
							</div>
							<div class="noblackgrond">
