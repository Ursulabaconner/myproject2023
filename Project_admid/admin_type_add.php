                        ...
                        <div class="row">
							<div class="col-lg-6">
								<?php
									...
									if($name=="") {
								?>
									<h3>Pls add type name</h3>
									<?php
									 exit();
									}
									include "connect.php";
									$sql="insert into produt_type values('','$name')";
									$result=$c->query($sql);
									if($result==true) { 
									?>
									<h3>Add type be completed</h3>
									<a href="show_type.php">back to show Type</a>
									<?php
									}else {
									?>
									<h3>error : Add type be not completed</h3>".
									<?php
									mysql_error();
									}
									$c->close();
