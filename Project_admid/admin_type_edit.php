                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-lg-6">
                            <?php
								...
								$sql="select * from produt_type where pt_id='$id_edit'";
								$result=$c->query($sql);
							...
							<div class="card-body card-block">
                                <div class="has-success form-group">
									<form method="POST" action="admin_type_edit2.php">
										<label class=" form-control-label">Pls add name type</label>
										<input type="text" name="typename"value="<?=$name_type?>" class="is-valid form-control-success form-control">
										<p class="help-block">กรุณากรอกเป็นตัวอักษร.</p>
										<input type="hidden" name="id_edit" value="<?=$id_type?>">
