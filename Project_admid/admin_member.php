									...
									<div class="table-responsive table--no-card m-b-30">
										<table class="table table-borderless table-striped table-earning">
											<thead>
												...
												<?php 
												include "connect.php";
												 $sql="select * from member order by mb_id desc";
												 $result = $c->query($sql);
												...
												if($number<>0) {
												 ...
												 $date_mb=$rs["mb_date"];
												 $gender_mb=$rs["mb_gender"];
												 $phone_mb=$rs["mb_phone"];
												 $profile_mb=$rs["mb_profile"];
												 ?>
												 <tr>
												 <td><?php echo $code_mb ?></td>
												 <td><?php echo$username_mb ?></td>
												 <td><?php echo$password_mb ?></td>
												 <td><?php echo$fname_mb ?></td>
												 <td><?php echo$lname_mb ?></td>
												 <td><?php echo$date_mb ?></td>
												 <td><?php echo$gender_mb ?></td>
												 <td><?php echo$phone_mb ?></td>
												 <td><img src="../<?php echo$profile_mb ?>"></td>
												 <td><a href= "member_edit.php?id_edit=<?=$id_mb?>">[แก้ไข]</a></td>
												 <td><a href="member_delete.php?id_del=<?=$id_mb?>&photo_del=<?=$profile_mb?>\" onclick=\"return
