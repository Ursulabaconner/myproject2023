                            ...
                            <div class="header-button">
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">john Zeed</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <span class="email">mai_wolffox@hotmail.com</span>
                                                </div>
                                            </div>
						...
						<div class="au-task js-list-load">
							<div class="au-task__item-inner">
								...
								<?php include "connect.php";
									 $sql="delete from productmaster where pm_id='$id_del' ";
									 $result=$c->query($sql);
									 if($photo_del<>"") {
									 ...
									 if($result) {
									 echo "<h3>Deleta Product be completed</h3>";
									 echo "[<a href=admin_product.php>back to show Product?</a> ] ";
									 }
									 else { echo "<h3>Error : Deleta Product not be completed</h3>";
									 }
									 $c->close();
								?>
							</div>
