                ...
                <div class="section__content section__content--p30">
					...
					?>
						...
						<div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Order Cancer</h3>
                                    ...
                                    <table class="table table-data2">
										...
										if($number<>0) {
											...
											while($rs=$result->fetch_assoc()) {
												...
												$strSQL1 = "SELECT * FROM sily_img WHERE od_id = $id_order ";
												$objQuery1 = mysqli_query($c,$strSQL1);
												$objResult1 = mysqli_fetch_array($objQuery1,MYSQLI_ASSOC);
												$state_sily = $objResult1["status_sily"];
												/*echo $id_status;
												echo $state_sily;*/
												if($id_status == "Cancer" || $state_sily == "Refund"){
										?>
                                        <tbody>
                                            <tr class="tr-shadow">
                                                <!--<td>
												...
												<?php
													}else if($id_status  == "Refund"){
												?>
													<span class="status--denied">Wait for Refund</span>
												<?php
													}else if($id_status  == "Refund compile"){
												?>
													<span class="status--denied">Refund Compile</span>
												<?php
													}
												?>
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        <?php
															if($id_status == "Refund"){
														?>
														<button class="item" data-toggle="tooltip" data-placement="top" title="Refund">
                                                            <a href="refund_order.php?od_get_id=<?php echo $id_order?>"  class="fa fa-share-square" ></a>
                                                        </button>
                                                        <?php
															}
														?>
                                                        ...
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Delete">
                                                            <a href="Delete_order.php?id_del=<?php echo $id_order?>" class="zmdi zmdi-delete"></a>
                                                        </button>
