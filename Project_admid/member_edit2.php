                    ...
                    <div class="au-task js-list-load">
                        <div class="au-task__item-inner">
							<?php
								 ...
								 $fname=$_POST["mb_firstName"];
								 $lname=$_POST["mb_lastName"];
								 $gender=$_POST["mb_gender"];
								 $phone=$_POST["mb_phone"];

								 $mbprofileimg= rand(1000,100000)."-".$_FILES['mbprofileimg']['name'];
								 $file_loc = $_FILES['mbprofileimg']['tmp_name'];
								 $file_size = $_FILES['mbprofileimg']['size'];
								 $file_type = $_FILES['mbprofileimg']['type'];
								 $folderimg="imgMember/";
								 $filepath=$folderimg.$mbprofileimg;
								 move_uploaded_file($file_loc,$folderimg.$mbprofileimg);
								 
								 include "connect.php";
								 $sql="update member set mb_email='$email',mb_username='$username',mb_password='$password',mb_firstName='$fname',mb_lastName='$lname',mb_date='$date',mb_gender='$gender',mb_phone='$phone',mb_profile='$filepath' where mb_id='$id_edit' ";
								 $result=$c->query($sql);
								 if($result) {
								 echo "<h3>Edit Member completed</h3>";
								 echo "[<a href=admin_member.php>back to show Member?</a> ] ";
								 } else {
								 echo "<h3>Error :Edit Product not completed</h3>";
								 }
								 $c->close();
							?>
                        </div>
