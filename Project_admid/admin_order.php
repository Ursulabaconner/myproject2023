        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
					...
					//print_r($_SESSION);
					include "connect.php";
					$sql="select * from order_detail order by od_id desc";
					$result = $c->query($sql);
                                ...
                                <div class="table-responsive table-responsive-data2">
                                    <table class="table table-data2">
										...
										<?php
											 ...
											 $id_order=$rs["od_id"];
											 $code_pro=sprintf("%05d",$id_order);
											 $order_name=$rs["od_name"];
											 $order_addr=$rs["od_address"];
											 $order_tel=$rs["od_tel"];
											 $order_email=$rs["od_email"];
											 $order_Date=$rs["od_date"];
											 
											 $strSQL1 = "SELECT * FROM order_state WHERE od_id = $id_order ";
                                        ...
                                        <tbody>
                                            <tr class="tr-shadow">
												...
												<td><a href= 'admin_view_order.php?qty_id=<?php echo $id_order?>'><?php echo $code_pro ?></a></td>
                                                <td><?php echo $order_name ?></td>
                                                <td>
                                                    <span class="block-email"><?php echo $order_email ?></span>
                                                </td>
                                                <td class="desc"><?php echo $order_addr ?></td>
                                                <td><?php echo $order_Date ?></td>
                                                <td>
												<?php
													if($objResult1["status"] == "Wait" ){
												?>
                                                    <span class="status--denied">Wait</span>
												<?php
													}else if($objResult1["status"] == "Post"){
												?>
													<span class="status--process">Processed</span>
												<?php
													}else if($objResult1["status"] == "Refund"){
												?>
													<span class="status--denied">Wait for Refund</span>
												<?php
													}else if($objResult1["status"] == "Cancer"){
												?>
													<span class="status--denied">Cancer</span>
												<?php
													}else if($objResult1["status"] == "Complete"){
												?>
													<span class="status--process">Complete</span>
												<?php
													}else if($objResult1["status"] == "Refund complete"){
												?>
													<span class="status--process">Refund Complete</span>
												<?php
													}
												?>
												
                                                </td>
                                                <td><?=$objResult1["total_price"];?></td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="Cancer">
                                                            <a href="cancer_order.php?od_get_id=<?php echo $id_order?>" class="zmdi zmdi-delete"></a>
                                                        </button>
                                                        <button class="item" data-toggle="tooltip" data-placement="top" title="More">
                                                            <i href="#" class="zmdi zmdi-more"></i>
                                                        </button>
                                                    </div>
                                                </td>
                                            </tr>
