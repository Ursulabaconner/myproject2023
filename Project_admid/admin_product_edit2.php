                    ...
                    <div class="au-task js-list-load">
                        <div class="au-task__item-inner">
							<?php
								 ...
								 include "connect.php";
								 $sql="update productmaster set pm_name='$name',pm_detail='$detail',pm_qty='$weight',pm_time='$date',pm_price='$price',pm_size='$size',pm_type='$ref_id_type',pm_img='$filepath' where pm_id='$id_edit' ";
								 $result=$c->query($sql);
								 if($result) {
								 echo "<h3>Edit Product completed</h3>";
