                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
						...
						<?php
							...
							$strSQL = "SELECT * FROM member order by mb_id desc ";
							$objQuery = mysqli_query($c,$strSQL);
							$objResult = mysqli_fetch_array($objQuery,MYSQLI_ASSOC);
							
							$strSQL1 = "SELECT * FROM order_qty order by od_id desc";
						...
						<div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Order real time</h2>
                                <div class="table-responsive table--no-card m-b-40">
                                    <table class="table table-borderless table-striped table-earning">
										...
										<?php
										include "connect.php";
										$sqlorder="select * from order_detail order by od_date desc";
										$result = $c->query($sqlorder);
										...
										$sqlqty="select qty from order_qty where od_id=$id_order ";
										$result1=$c->query($sqlqty);
										$rs1=$result1->fetch_assoc();
										$qty_order=$rs1["qty"];
										
										$sqldetail="select total_price from order_state where od_id=$id_order ";
										$result2=$c->query($sqldetail);
										$rs2=$result2->fetch_assoc();
										$TT_price=$rs2["total_price"];
										?>
                                        <tbody>
                                            <tr>
                                                <td><?=$order_Date?></td>
                                                <td><?=$code_order?></td>
                                                <td><?=$order_name?></td>
                                                <td class="text-right"><?=$qty_order?></td>
                                                <td class="text-right"><?=$TT_price?></td>
                                            </tr>
											<?php 
										}
										$c->close();
