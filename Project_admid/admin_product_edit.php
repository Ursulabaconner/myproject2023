                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Edit Type name</h2>
                                </div>
                            </div>
                        </div>
                        <div class="card">
									...
									<?php
										 ...
										 include "connect.php";
										 $sql="select * from productmaster where pm_id='$id_edit' ";
										 $result=$c->query($sql);
										 ...
										 $photo_pro=$rs["pm_img"];
									?>
                                        <form action="admin_product_edit2.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="pm_name" placeholder="Text" class="form-control" value="<?=$name_pro?>">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="pm_detail" id="textarea-input" rows="9" class="form-control" value="<?=$detail_pro?>"></textarea>
                                                </div>
                                            </div>
											<div class="row form-group">
												<div class="col col-md-3">
												...
												<div class="col-12 col-md-9">
													<input id="cc-pament" name="pm_qty" type="text" class="form-control" aria-required="true" aria-invalid="false" value="<?=$qty_pro?>">
												</div>
											</div>
											<div class="row form-group">
												<div class="col col-md-3">
												...
												<div class="col-12 col-md-9">
													<input id="cc-pament" name="pm_price" type="text" class="form-control" aria-required="true" aria-invalid="false" value="<?=$price_pro?>">
												</div>
											</div>
											<div class="row form-group">
												<div class="col col-md-3">
												...
												<div class="col-12 col-md-9">
													<input id="cc-pament" name="pm_size" type="text" class="form-control" aria-required="true" aria-invalid="false" value="<?=$size_pro?>">
												</div>
											</div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="file" id="file-input" name="fileimg" class="form-control-file" value="<?=$photo_pro?>">
													<script>
											...
											<input type="hidden" name="pm_id" value="<?=$id_pro?>">
