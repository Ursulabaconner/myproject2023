    ...
    <header>
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-3">
                    <div class="full">
                        <a class="logo" href="index.html"><img src="images/logo.png" alt="index.html" /></a>
                    </div>
                </div>
                <div class="col-md-9">
                    <div class="full">
                        <div class="right_header_info">
                            <ul>
                                ...
                                <li class="button_user"><a class="button active" href="login.php">Login</a><a class="button" href="#">Register</a></li>
                ...
                <div class="row">
                  <div class=" col-md-12">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <form class="main_form" method="post" action="check_login.php">
                            <div class="row">
                             
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <input class="form-control" placeholder="Name" type="text" name="txtUsername">
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                    <input class="form-control" placeholder="password" type="text" name="txtPassword">
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
