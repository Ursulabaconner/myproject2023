...
<head>
    ...
    <title>Add Address | AK-cosplay</title>
			...
			<div class="row">
				<div class="col-sm-4 ">
					...
					<?php
						 ...
						 include "connect.php";
						 $sql="insert into address_member values(null,'$Uid','$Addressmb')";
						 $result=$c->query($sql);

						 echo "<h3>Add Address Completed</h3>";
						 echo "[<a href='pfmember.php'>กลีบไปโปรไฟล์?</a>] ";
						 mysqli_close($c);
						 ?>
				</div>
			</div>
