...
<head>
    ...
    <title>Sign up | AK-cosplay</title>
			...
			<div class="row">
				<div class="col-sm-4 ">
					<div class="signup-form"><!--sign up form-->
						...
						<form action="sign-done.php" method="post" enctype="multipart/form-data">
							<input name="mb_user" type="text" placeholder="Username"/>
							<input name="mb_pw" type="password" placeholder="Password"/>
							<input name="mb_email" type="email" placeholder="Email Address"/>
							<input name="mb_FN" type="text" placeholder="Firstname"/>
							<input name="mb_LN" type="text" placeholder="Lastname"/>
							...
							<input name="mb_phone" type="text" placeholder="Phone"/>
